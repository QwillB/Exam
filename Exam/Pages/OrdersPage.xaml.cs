    ...
    public partial class OrdersPage : Page
    {
        ...
        private void GetOrderList()//метод для вывода заказов текущего пользователя на странцу
        {
            ...
            for (int i = 0; i < productsCount; i++)//в цикле создаются отдельные элементы в которых хранятся данные о товарах
            {
                ...
                orderIdLabel.FontFamily = new FontFamily("Comic Sans MS");
                ...
                orderDateLabel.FontFamily = new FontFamily("Comic Sans MS");
                ...
                orderCompositionLabel.FontFamily = new FontFamily("Comic Sans MS");
                ...
                orderSumLabel.FontFamily = new FontFamily("Comic Sans MS");
                ...
                orderDiscountLabel.FontFamily = new FontFamily("Comic Sans MS");
                ...
                orderPickupPointLabel.FontFamily = new FontFamily("Comic Sans MS");
                ...
                orderPickupCodeLabel.FontFamily = new FontFamily("Comic Sans MS");
                Button printOrderButton = new();
                printOrderButton.Content = "Распечатать талон заказа";
                printOrderButton.FontFamily = new FontFamily("Comic Sans MS");
